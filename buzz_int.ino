/* vibration sensing using SW-420, to detect vibration and acitvates buzzer for 2s, 
ultrasonic sensor for distance detection and beeps at higher frequncy for shorter distances,
buzzer beeps on startup to signifiy working*/
